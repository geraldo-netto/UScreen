...
cp scripts/install.sh scripts/setup-evdi.sh scripts/write-desktop-entry.sh scripts/write-systemd-service.sh scripts/uscreen.desktop scripts/uscreen-autostart.desktop scripts/uscreen-service-autostart.desktop scripts/uscreen.service scripts/copy-distribution-docs.sh "$DEST/scripts/"
