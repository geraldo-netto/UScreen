...
| Convert horizontal damage spans — T554 | 64×64 patch: 26.29 µs; narrow strip: 119.13 µs | 3.78 µs; 9.73 µs | **85.6% / 91.8% less conversion time** | 1280×800, scale 1, eight-participant pool. 640×360 window CPU: 232.03 to 97.57 µs, **57.9% lower**. Full-screen changes do not gain pixel savings; scale-2 full-frame time regressed 8.1%. These measurements concern FIFO capture; T570 below separately extends damage histories to shared slots. [Source](2026-09-20-damage-regions/README.md#isolated-measurements). |
| Skip unused EVDI conversion — T580 | 0.73 CPU seconds / 16-second trial | 0.47 CPU seconds / trial | **35.6% less helper CPU** | Optional GPU capture with no FIFO reader; three pairs improved 30.1–36.5%. Native static-screen FIFO fallback delivered full frames in 9–42 ms. Ordinary FIFO encoding still converts; no latency, battery or full-pipeline zero-copy claim. [Source](2026-09-21-fifo-demand/README.md). |
| Retain damage per shared capture slot — T570 | Idle: 103.561 µs; 64×64 patch: 103.500 µs | 1.523 µs; 5.731 µs | **98.5% / 94.5% lower stage time** | 1280×800, scale 1, eight workers, five paired replays; all 60 pixel-hash pairs across scales/cases match. Includes fixture mutation, damage, conversion and publication; excludes EVDI, encoding, USB and rendering. Full-frame results mixed. [Source](2026-09-21-shared-damage/README.md). |
...
| --- | --- | --- |
| X11 GPU capture — T575 | Combined encoder/helper CPU rate 0.07883 to 0.05303 seconds/second (**32.7% lower**), but source-update-to-render-ACK p50 28.72 to 37.43 ms and p95 38.26 to 52.89 ms | Implemented opt-in prototype; FIFO default retained. Five differing-cadence pairs plus two final-code confirmation pairs all worsen latency. Cross-device implicit-layout import rejected after patterned corruption. No total-system power or full-pipeline zero-copy claim. [Source](2026-09-21-gpu-adapter/README.md). |
